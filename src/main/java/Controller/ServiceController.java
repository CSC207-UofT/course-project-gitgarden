        ...
        if (isValidName(name)) {
            if (isValidAddress(address)) {
                if (isUniqueName(name)) {
                    if (flag) {
                        profileManager.createFarmer(name, address, id);
                    } else {
                        profileManager.createDistributor(name, address, id);
                    }
                } else {
                    throw new Exception("That name has been taken.");
                }
            } else {
                throw new Exception("Please enter an alphanumeric address.");
            }
        } else {
            throw new Exception("Please enter an alphanumeric name containing at least one letter.");
        }
