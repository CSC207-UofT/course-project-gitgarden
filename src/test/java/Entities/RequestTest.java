...
public class RequestTest {
    ...
    IRequest request1 = new Request(random.nextInt(800000000) + 100000000, farmer1, "requestName1", 100, 10, null);
    IRequest request2 = new Request(random.nextInt(800000000) + 100000000, farmer2, "requestName2", 200, 20, null);
    ...
    public void TestGetRequest_id(){
        assertTrue( 100000000 <= request1.getRequestId() && request1.getRequestId() <= 999999999);
    }
